	...
	<table id="rounded-corner">
		<thead>
			<tr>
				...
				<th scope="col" class="rounded">Téléphone</th>
		...
		<tfoot>
		 ...
		 <tbody>
			...
			<tr>
				...
				<td><?php echo ucfirst($aValue['nom']); ?></td>
				<td><?php echo ucfirst($aValue['prenom']); ?></td>
				<td><?php echo $aValue['mail']; ?></td>
				<td><?php echo $aValue['tel']; ?></td>
				<td>

...
if(isset($aControllerDatas['notification'])){
	...
	if($aControllerDatas['notification'] == 'success'){
		...
		<div class="success message">
			<p>Section modifiée avec succès.</p>
		</div>
		<?php
	}
}
...
?>
<div id="profil">
<h2>Éditer une section<?php echo form_input('Retour à la liste','',array('type' => 'submit', 'class' => 'button small blue', 'onclick' => 'window.location = \'../index\'')); ?></h2>
	<?php 
